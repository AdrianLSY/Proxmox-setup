...
#
# This script ensures a PCI device is bound to the vfio-pci driver
...
log "INFO" "starting VFIO binding process"
...
log "INFO" "device $DEV successfully bound to vfio-pci"
exit 0
